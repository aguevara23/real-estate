...
var MobileMenu = function () {
  function MobileMenu() {
    ...
    this.navItem = (0, _jquery2.default)(".primary-nav a");
    this.navLogo = (0, _jquery2.default)(".site-header__logo");
    this.events();
  }
    ...
    value: function createHeaderWaypoint() {
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          if (direction == "down") {
            that.siteHeader.addClass("site-header--dark site-header__logo--light");
          } else {
            that.siteHeader.removeClass("site-header--dark site-header__logo--light");
          }
        }
      });
    }
